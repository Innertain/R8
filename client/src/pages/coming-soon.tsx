...
export default function ComingSoonPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stormy-dark to-stormy-primary/20">
      {/* R4 Volunteer Portal Banner */}
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 text-white py-3 px-4 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <Users className="w-5 h-5 flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-sm sm:text-base font-semibold truncate">
                <span className="hidden sm:inline">R4 Volunteers: </span>Access your volunteer dashboard & manage shifts
              </p>
            </div>
          </div>
          <Link href="/r4-volunteer">
            <Button 
              ...
              data-testid="button-r4-volunteer-banner"
            >
              Volunteer Portal →
            </Button>
          </Link>
