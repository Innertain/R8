...
export default function ComingSoonPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stormy-dark to-stormy-primary/20">
      ...
      <div className="relative min-h-[60vh] lg:min-h-screen hero-mobile overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-10 flex items-center justify-center min-h-[60vh] lg:min-h-screen px-4 lg:px-6 py-6 lg:py-12">
          <div className="text-center space-y-6 lg:space-y-12 max-w-5xl mx-auto">
      ...
      {/* Mission Section */}
<section className="relative py-8 lg:py-20 min-h-[35vh] lg:min-h-screen flex items-center overflow-hidden -mt-12 lg:-mt-32">
