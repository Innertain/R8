...
export function StateIcon({ state, size = 24, className = "", color = "currentColor" }: StateIconProps) {
  ...
  return (
    <svg 
      ...
      viewBox="0 0 50 50"
    >
      <use href={`#icon-state-${stateCode}`} fill={color} />
    </svg>
  );
}

// Component to include the SVG definitions once in the app
      ...
      <svg>
        <defs>
          ...
          <symbol id="icon-state-OH" viewBox="0 0 50 50">
            <path d="M27.3,15.7l8.9,1.1l0.4,5.5l0.2,7.7l-6.8,0.9l-0.2,1.5l-7.9,0.2l-0.2-1.1l-3.8,0.4l-0.2-0.6l-1.3,0.2l-0.2-0.9l-5.7,0.4l-0.2-0.6V23l-0.2-0.9l-1.5,0.2l-0.2-0.6l-3.6,0.2l-0.4-1.1l-1.7,0.2l-0.2-0.6l-5.9,0.4l-1.1-8.9L27.3,15.7z"/>
          </symbol>
          <symbol id="icon-state-OK" viewBox="0 0 50 50">
            <path d="M12.3,22.7l15.4,0.6l8.4,0.2l0.6,15.6l-5.5,0.2l-0.6,7.7l-6.8,0.4l-0.6,1.5l-7.9,0.2l-0.6-1.1l-3.8,0.2l-0.6-0.6l-1.3,0.2l-0.6-0.9L12.3,22.7z"/>
          </symbol>
          <symbol id="icon-state-OR" viewBox="0 0 50 50">
            <path d="M2.6,12.1l2.1,0.4l1.9-1.5l1.5,0.8l2.8-0.6l0.8,1.3l1.5-0.2l0.4,1.9l2.1-0.6l0.6,1.5l1.7-0.8l0.2,1.7l1.9-0.4l0.8,1.1l1.3-0.6l0.4,1.5l1.7-0.2l0.6,1.3l1.5-0.8l0.2,1.9l1.9-0.4l0.8,1.1l-8.9,1.1l-0.4,5.5l-7.7,0.2l-0.9,6.8l-1.5,0.2l-0.2,7.9L2.6,12.1z"/>
          </symbol>
          <symbol id="icon-state-PA" viewBox="0 0 50 50">
            <path d="M25.5,18.1l15.4,1.1l8.4,0.6l0.2,15.6l-5.5,0.4l-0.2,3.7l-6.8,0.9l-0.2,1.5l-7.9,0.2l-0.2-1.1l-3.8,0.4l-0.2-0.6l-1.3,0.2l-0.2-0.9l-5.7,0.4l-0.2-0.6V30l-0.2-0.9l-1.5,0.2l-0.2-0.6l-3.6,0.2l-0.4-1.1l-1.7,0.2l-0.2-0.6l-5.9,0.4l-1.1-8.9L25.5,18.1z"/>
          </symbol>
          <symbol id="icon-state-RI" viewBox="0 0 50 50">
            <path d="M42.3,18.5l0.4,3.5l0.2,3.7l-1.8,0.4l-0.2,1.5l-1.1,0.2l-0.2-1.1l-0.8,0.2l-0.2-0.6l-0.3,0.1l-0.1-0.4l-0.7,0.1l-0.1-0.3l-0.5,0.1l-0.1-0.3l-0.8,0.1l-0.1-0.9L42.3,18.5z"/>
          </symbol>
          <symbol id="icon-state-SC" viewBox="0 0 50 50">
            <path d="M28.3,27.5l8.9,1.1l0.4,5.5l0.2,7.7l-6.8,0.9l-0.2,1.5l-7.9,0.2l-0.2-1.1l-3.8,0.4l-0.2-0.6l-1.3,0.2l-0.2-0.9l-5.7,0.4l-0.2-0.6V34l-0.2-0.9l-1.5,0.2l-0.2-0.6l-3.6,0.2l-0.4-1.1l-1.7,0.2l-0.2-0.6l-5.9,0.4l-1.1-8.9L28.3,27.5z"/>
          </symbol>
          <symbol id="icon-state-SD" viewBox="0 0 50 50">
            <path d="M12.3,12.7l15.4,0.6l8.4,0.2l0.6,15.6l-5.5,0.2l-0.6,7.7l-6.8,0.4l-0.6,1.5l-7.9,0.2l-0.6-1.1l-3.8,0.2l-0.6-0.6l-1.3,0.2l-0.6-0.9L12.3,12.7z"/>
          </symbol>
          <symbol id="icon-state-TN" viewBox="0 0 50 50">
            <path d="M15.3,24.5l15.4,0.6l8.4,0.2l15.6,0.6l0.2,9.6l-23.6,0.2l-0.2-5.5l-7.7-0.2l-0.4-6.8l-1.5-0.2l-0.2-3.9L15.3,24.5z"/>
          </symbol>
          <symbol id="icon-state-TX" viewBox="0 0 50 50">
            <path d="M8.3,18.7l15.4,0.6l8.4,0.2l0.6,15.6l-2.5,0.2l-0.6,7.7l-3.8,0.4l-0.6,1.5l-4.9,0.2l-0.6-1.1l-2.8,0.2l-0.6-0.6l-1.3,0.2l-0.6-0.9l-2.8,0.2l-0.2-0.6v-1.9l-0.2-0.9l-1.5,0.2l-0.2-0.6l-1.6,0.1l-0.2-0.5L8.3,18.7z"/>
          </symbol>
          <symbol id="icon-state-UT" viewBox="0 0 50 50">
            <path d="M12.3,12.7l15.4,0.6l8.4,0.2l0.6,23.6l-5.5,0.2l-0.6,7.7l-6.8,0.4l-0.6,1.5l-7.9,0.2l-0.6-1.1l-3.8,0.2l-0.6-0.6l-1.3,0.2l-0.6-0.9L12.3,12.7z"/>
          </symbol>
          <symbol id="icon-state-VA" viewBox="0 0 50 50">
            <path d="M25.5,24.1l15.4,1.1l8.4,0.6l0.2,9.6l-5.5,0.4l-0.2,3.7l-6.8,0.9l-0.2,1.5l-7.9,0.2l-0.2-1.1l-3.8,0.4l-0.2-0.6l-1.3,0.2l-0.2-0.9l-5.7,0.4l-0.2-0.6V32l-0.2-0.9l-1.5,0.2l-0.2-0.6l-3.6,0.2l-0.4-1.1l-1.7,0.2l-0.2-0.6l-5.9,0.4l-1.1-8.9L25.5,24.1z"/>
          </symbol>
          <symbol id="icon-state-VT" viewBox="0 0 50 50">
            <path d="M42.3,8.5l0.4,5.5l0.2,7.7l-1.8,0.9l-0.2,1.5l-2.1,0.2l-0.2-1.1l-1.9,0.2l-0.2-0.6l-1.3,0.2l-0.2-0.9l-2.8,0.2l-0.2-0.6v-1.9l-0.2-0.9l-1.5,0.2l-0.2-0.6l-1.8,0.1l-0.2-0.5L42.3,8.5z"/>
          </symbol>
          <symbol id="icon-state-WA" viewBox="0 0 50 50">
            <path d="M2.6,2.1l2.1,0.4l1.9-1.5l1.5,0.8l2.8-0.6l0.8,1.3l1.5-0.2l0.4,1.9l2.1-0.6l0.6,1.5l1.7-0.8l0.2,1.7l1.9-0.4l0.8,1.1l1.3-0.6l0.4,1.5l1.7-0.2l0.6,1.3l1.5-0.8l0.2,1.9l1.9-0.4l0.8,1.1l-8.9,1.1l-0.4,5.5l-7.7,0.2l-0.9,6.8l-1.5,0.2l-0.2,7.9L2.6,2.1z"/>
          </symbol>
          <symbol id="icon-state-WI" viewBox="0 0 50 50">
            <path d="M20.5,8.1l8.9,1.1l0.4,5.5l0.2,7.7l-6.8,0.9l-0.2,1.5l-7.9,0.2l-0.2-1.1l-3.8,0.4l-0.2-0.6l-1.3,0.2l-0.2-0.9l-5.7,0.4l-0.2-0.6V16l-0.2-0.9l-1.5,0.2l-0.2-0.6l-3.6,0.2l-0.4-1.1l-1.7,0.2l-0.2-0.6l-5.9,0.4l-1.1-8.9L20.5,8.1z"/>
          </symbol>
          <symbol id="icon-state-WV" viewBox="0 0 50 50">
            <path d="M25.5,20.1l8.9,1.1l0.4,5.5l0.2,7.7l-6.8,0.9l-0.2,1.5l-7.9,0.2l-0.2-1.1l-3.8,0.4l-0.2-0.6l-1.3,0.2l-0.2-0.9l-5.7,0.4l-0.2-0.6V27l-0.2-0.9l-1.5,0.2l-0.2-0.6l-3.6,0.2l-0.4-1.1l-1.7,0.2l-0.2-0.6l-5.9,0.4l-1.1-8.9L25.5,20.1z"/>
          </symbol>
          ...
          <symbol id="icon-state-USA" viewBox="0 0 50 50">
            <path d="M2.3,8.1l15.4,1.7l8.4,1.9l13.6,3.0l-1.1,15.4l-1.5,21.5l-23.6-5.3l-0.2-8.9l-1.1-0.4l-0.2-7.7l-1.3-0.4l-0.2-9.1l-0.4-0.2l-0.2-1.3L2.3,8.1z"/>
          </symbol>
        </defs>
      </svg>
    </div>
