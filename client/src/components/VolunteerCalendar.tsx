...
${format(event.start, 'MMM d, h:mm a')} - ${format(event.end, 'h:mm a')}`;
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border border-dashed border-gray-300 rounded-lg gap-3">
            ...
            <Button 
              ...
              className="hover:text-blue-600 hover:border-blue-300 w-full sm:w-auto flex-shrink-0"
            >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border border-dashed border-gray-300 rounded-lg gap-3">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-br from-red-500 via-orange-500 to-yellow-500 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <Button 
              ...
              className="hover:text-orange-600 hover:border-orange-300 w-full sm:w-auto flex-shrink-0"
            >
              <Link className="h-4 w-4 mr-2" />
              Connect
            </Button>
