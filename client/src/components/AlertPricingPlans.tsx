...
export function AlertPricingPlans() {
  ...
  return (
    <div className="py-8">
      ...
      {/* Use Case Examples */}
      <div className="mt-12 bg-gradient-to-br from-green-50 to-blue-50 border border-green-200 rounded-lg p-8 max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Real-World Use Case Examples</h3>
          <p className="text-gray-700">See how organizations use our platform for emergency communication and community engagement</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-green-200 rounded-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">Use Case 1: Welfare Check</h4>
                <p className="text-sm text-gray-600">Tornado emergency response</p>
              </div>
            </div>
            
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <h5 className="font-medium text-sm text-gray-900 mb-2">SMS Template:</h5>
              <div className="text-sm font-mono bg-white border rounded p-3">
                <div className="text-red-600 font-bold">⚡ WELFARE CHECK</div>
                <div className="mt-2">There was a major tornado in your area. Please let us know if you're okay.</div>
                <div className="mt-2">1 – YES, I'm okay</div>
                <div>2 – NO, I need help</div>
                <div className="mt-2 text-gray-500">Text STOP to opt out.</div>
              </div>
            </div>
            
            <div className="bg-blue-50 rounded-lg p-3">
              <h5 className="font-medium text-xs text-blue-900 mb-1">Follow-up (if they reply "2"):</h5>
          ...
          <div className="bg-white border border-green-200 rounded-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">Use Case 2: Business Closure</h4>
                <p className="text-sm text-gray-600">Hurricane preparation notice</p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <h5 className="font-medium text-sm text-gray-900 mb-2">SMS Template:</h5>
              <div className="text-sm font-mono bg-white border rounded p-3">
                <div className="text-orange-600 font-bold">🌪️ BUSINESS CLOSURE</div>
                <div className="mt-2">Due to the hurricane forecast (view alert), our business will be closed for the next 2 days.</div>
                <div className="mt-2">Please stay safe and follow local guidance.</div>
                <div className="mt-2 text-gray-500">Text STOP to opt out.</div>
              </div>
            </div>
            
            <div className="bg-green-50 rounded-lg p-3">
              <h5 className="font-medium text-xs text-green-900 mb-1">Perfect for:</h5>
              <div className="text-xs text-green-800">
                Restaurants, retail stores, service businesses, schools
              </div>
            </div>
          </div>

          {/* Use Case 3: Community Service */}
          <div className="bg-white border border-green-200 rounded-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">Use Case 3: Free Meal Alert</h4>
                <p className="text-sm text-gray-600">Community assistance program</p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <h5 className="font-medium text-sm text-gray-900 mb-2">SMS Template:</h5>
              <div className="text-sm font-mono bg-white border rounded p-3">
                <div className="text-green-600 font-bold">🍲 FREE HOT MEALS</div>
                <div className="mt-2">We're serving FREE hot meals at 123 Main St. from 11 AM–3 PM while supplies last.</div>
                <div className="mt-2">Reply with any questions.</div>
                <div className="mt-2 text-gray-500">Text STOP to opt out.</div>
              </div>
            </div>
            
            <div className="bg-purple-50 rounded-lg p-3">
              <h5 className="font-medium text-xs text-purple-900 mb-1">Great for:</h5>
              <div className="text-xs text-purple-800">
                Churches, food banks, community centers, disaster relief
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <div className="bg-white border border-blue-200 rounded-lg p-6 max-w-2xl mx-auto">
            <h4 className="font-semibold text-gray-900 mb-3">Create Your Own Custom Messages</h4>
            <p className="text-sm text-gray-600 mb-4">
              These are just examples! Our platform lets you create any custom message for your specific needs - 
              from school announcements to volunteer coordination to emergency response.
            </p>
            <div className="flex flex-wrap justify-center gap-2 text-xs">
              <Badge variant="outline" className="text-blue-600 border-blue-200">Event Notifications</Badge>
              <Badge variant="outline" className="text-green-600 border-green-200">Volunteer Coordination</Badge>
              <Badge variant="outline" className="text-purple-600 border-purple-200">Fundraising Updates</Badge>
              <Badge variant="outline" className="text-orange-600 border-orange-200">Service Announcements</Badge>
              <Badge variant="outline" className="text-red-600 border-red-200">Safety Alerts</Badge>
            </div>
          </div>
        </div>
      </div>
